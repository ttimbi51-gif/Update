...
function renderSubmissionStatusMessage(targetId) {
  ...
  if (success === '1') {
    ...
    target.innerHTML = '<div class="submission-status error">There was a problem submitting your application. Please try again or contact us directly at info@waterkloofhillsecschool.co.za.</div>';
  }
}
